...
namespace SplineMesh {
    ...
    public class SplineSmoother : MonoBehaviour {
        ...
        [Tooltip("Check this to re-smooth the mesh.")]
        public bool resmoothMesh = false;

        private bool resmoothMeshStatus = true;

        private void OnValidate() {
            if (resmoothMesh == resmoothMeshStatus)
            {
                SmoothAll();
            }
        }
